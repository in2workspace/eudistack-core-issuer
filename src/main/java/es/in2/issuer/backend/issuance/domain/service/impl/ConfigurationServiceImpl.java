...
import es.in2.issuer.backend.issuance.domain.model.entities.Configuration;
import es.in2.issuer.backend.issuance.domain.repository.ConfigurationRepository;
import es.in2.issuer.backend.issuance.domain.service.ConfigurationService;
