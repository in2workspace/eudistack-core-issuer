...
import es.in2.issuer.backend.issuance.domain.util.IssuanceErrorTypes;
...
class IssuanceExceptionHandlerTest {
    ...
    private IssuanceExceptionHandler handler;   // SUT
    ...
    void handleTemplateReadException_usesExceptionMessage_whenPresent() {
        ...
        String type   = IssuanceErrorTypes.TEMPLATE_READ_ERROR.getCode();
    ...
    void handleOrganizationIdentifierMismatchException_usesExceptionMessage_whenPresent() {
        ...
        String type   = IssuanceErrorTypes.ORGANIZATION_ID_MISMATCH.getCode();
    ...
    void handleNoSuchEntityException_usesExceptionMessage_whenPresent() {
        ...
        String type   = IssuanceErrorTypes.NO_SUCH_ENTITY.getCode();
    ...
    void handleMissingRequiredDataException_usesExceptionMessage_whenPresent() {
        ...
        String type   = IssuanceErrorTypes.MISSING_REQUIRED_DATA.getCode();
