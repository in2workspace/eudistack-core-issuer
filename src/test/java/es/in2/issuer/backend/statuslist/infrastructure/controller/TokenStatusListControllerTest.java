...
class TokenStatusListControllerTest {
    ...
    void getTokenStatusList_whenOk_returnsResponseEntityWithStatuslistJwt() {
        ...
        when(statusListWorkflow.getSignedStatusListCredential(listId, StatusListFormat.TOKEN_JWT)).thenReturn(Mono.just(jwt));
        ...
        verify(statusListWorkflow).getSignedStatusListCredential(listId, StatusListFormat.TOKEN_JWT);
    }
    ...
    void getTokenStatusList_whenWorkflowFails_propagatesError() {
        ...
        when(statusListWorkflow.getSignedStatusListCredential(listId, StatusListFormat.TOKEN_JWT))
