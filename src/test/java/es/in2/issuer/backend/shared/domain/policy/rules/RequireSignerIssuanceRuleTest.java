...
class RequireSignerIssuanceRuleTest {
    ...
    void evaluate_succeedsWhenSysAdminWithOnboardingExecute() {
        ...
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(power), null, null, null, true, false, null, null);
    ...
    void evaluate_failsWhenSysAdminButMissingPower() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, null, true, false, null, null);
    ...
    void evaluate_failsWhenNotSysAdminEvenWithPower() {
        Power power = Power.builder()
                .function("Onboarding").action("Execute").build();
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(power), null, null, null, false, false, null, null);
