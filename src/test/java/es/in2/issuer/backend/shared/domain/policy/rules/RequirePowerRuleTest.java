...
class RequirePowerRuleTest {
    ...
    void evaluate_succeedsWhenPowerMatches() {
        ...
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(power), null, null, false, "DOME");
    ...
    void evaluate_succeedsWhenSysAdmin() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, true, "DOME");
    ...
    void evaluate_failsWhenNoPowersPresent() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, false, "DOME");
