...
class RequirePowerRuleTest {
    ...
    void evaluate_succeedsWhenPowerMatches() {
        ...
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(power), null, null, null, false, false, "DOME", null, null);
    ...
    void evaluate_succeedsWhenSysAdmin() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, null, true, false, "DOME", null, null);
    ...
    void evaluate_failsWhenNoPowersPresent() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, null, false, false, "DOME", null, null);
    ...
    void evaluate_failsWhenTenantDomainIsNull() {
        PolicyContext ctx = new PolicyContext("ORG-1", List.of(), null, null, null, false, false, null, null, null);
