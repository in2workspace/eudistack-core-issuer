...
class PolicyContextTest {
    ...
    void hasPower_returnsTrueWhenMatchingFunctionAndStringAction() {
        ...
        PolicyContext ctx = new PolicyContext("ORG1", List.of(power), null, null, null, false, false, null, null);
    ...
    void hasPower_returnsFalseWhenNoPowers() {
        PolicyContext ctx = new PolicyContext("ORG1", List.of(), null, null, null, false, false, null, null);
