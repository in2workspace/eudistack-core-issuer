...
class RequireOrganizationRuleTest {
    ...
    void evaluate_succeedsWhenOrganizationMatches() {
        PolicyContext ctx = new PolicyContext("ORG-123", List.of(), null, null, null, false, false, null, null);
    ...
    void evaluate_succeedsWhenSysAdmin() {
        PolicyContext ctx = new PolicyContext("ADMIN_ORG", List.of(), null, null, null, true, false, null, null);
    ...
    void evaluate_tenantAdminBypassesOrgCheck() {
        PolicyContext ctx = new PolicyContext("TENANT_ADMIN_ORG", List.of(), null, null, null, false, true, null, null);
    ...
    void evaluate_failsWhenNotSysAdminNotTenantAdminAndOrgMismatch() {
        PolicyContext ctx = new PolicyContext("ORG-A", List.of(), null, null, null, false, false, null, null);
